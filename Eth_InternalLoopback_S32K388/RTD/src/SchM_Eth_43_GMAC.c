...
#define SCHM_ETH_43_GMAC_AR_RELEASE_MINOR_VERSION_C     9
#define SCHM_ETH_43_GMAC_AR_RELEASE_REVISION_VERSION_C  0
#define SCHM_ETH_43_GMAC_SW_MAJOR_VERSION_C             7
#define SCHM_ETH_43_GMAC_SW_MINOR_VERSION_C             0
#define SCHM_ETH_43_GMAC_SW_PATCH_VERSION_C             1
...
void SchM_Enter_Eth_43_GMAC_ETH_EXCLUSIVE_AREA_00(void)
{
    uint32 msr;
    ...
    if(0UL == reentry_guard_ETH_EXCLUSIVE_AREA_00[u32CoreId])
    {
        ...
        msr = OsIf_Trusted_Call_Return(Eth_43_GMAC_schm_read_msr);
#else
        msr = Eth_43_GMAC_schm_read_msr();  /*read MSR (to store interrupts state)*/
...
void SchM_Exit_Eth_43_GMAC_ETH_EXCLUSIVE_AREA_00(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Enter_Eth_43_GMAC_ETH_EXCLUSIVE_AREA_01(void)
{
    uint32 msr;
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Exit_Eth_43_GMAC_ETH_EXCLUSIVE_AREA_01(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Enter_Eth_43_GMAC_ETH_EXCLUSIVE_AREA_02(void)
{
    uint32 msr;
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Exit_Eth_43_GMAC_ETH_EXCLUSIVE_AREA_02(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Enter_Eth_43_GMAC_ETH_EXCLUSIVE_AREA_03(void)
{
    uint32 msr;
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Exit_Eth_43_GMAC_ETH_EXCLUSIVE_AREA_03(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Enter_Eth_43_GMAC_ETH_EXCLUSIVE_AREA_35(void)
{
    uint32 msr;
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Exit_Eth_43_GMAC_ETH_EXCLUSIVE_AREA_35(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Enter_Eth_43_GMAC_ETH_EXCLUSIVE_AREA_36(void)
{
    uint32 msr;
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Exit_Eth_43_GMAC_ETH_EXCLUSIVE_AREA_36(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
