...
#define GMAC_IP_AR_RELEASE_MINOR_VERSION       9
#define GMAC_IP_AR_RELEASE_REVISION_VERSION    0
#define GMAC_IP_SW_MAJOR_VERSION               7
#define GMAC_IP_SW_MINOR_VERSION               0
#define GMAC_IP_SW_PATCH_VERSION               1
...
extern volatile uint16 Gmac_Ip_u16NumberOfClearedBd[FEATURE_GMAC_NUM_INSTANCES][FEATURE_GMAC_NUM_CHANNELS];
 ...
 *
 * This function works only with Flexible PPS mode selected.
 *
 * @param[in] Instance            Instance number
...
/*!
 * @brief Select PPS mode
 *
 * @param[in] Instance       Instance number
 * @param[in] SignalMode     TRUE Switch to Flexible PPS mode
 *                           FALSE Swtich to Fixed PPS mode
 */
 ...
 *
 * @retval GMAC_STATUS_SUCCESS    The command set successfully
 * @retval GMAC_STATUS_BUSY       The command failed to be set
 * @retval GMAC_STATUS_ERROR      Function called when Flexible PPS mode disabled.
 */
Gmac_Ip_StatusType Gmac_Ip_GeneratePulsePerSecondOutput(uint8 Instance,
 ...
 /*!
 * @brief Perform generating Fixed pulse(s) on Pulse Per Second.
 *
 * This function works only with Fixed PPS mode selected.
 *
 * @param[in] Instance       Instance number
 * @param[in] FixedClock     The fixed PPS clock
 * @retval GMAC_STATUS_SUCCESS    The command set successfully
 * @retval GMAC_STATUS_ERROR      Function called when Fixed PPS mode disabled.
 */
