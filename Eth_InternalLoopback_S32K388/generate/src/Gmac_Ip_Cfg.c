...
#define GMAC_IP_CFG_AR_RELEASE_MINOR_VERSION_C      9
#define GMAC_IP_CFG_AR_RELEASE_REVISION_VERSION_C   0
#define GMAC_IP_CFG_SW_MAJOR_VERSION_C              7
...
#endif
#ifdef GMAC_1_RXRING_2_DATA
    /*! @brief Reception data buffers for Rx Ring 2 */
    VAR_ALIGN(uint8 GMAC_1_RxRing_2_DataBuffer[(GMAC_1_MAX_RXBUFF_SUPPORTED * GMAC_1_MAX_RXBUFFLEN_SUPPORTED)], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
#endif
...
#endif
#ifdef GMAC_1_TXRING_2_DATA
    /*! @brief Transmission data buffers for Tx Ring 2 */
    VAR_ALIGN(uint8 GMAC_1_TxRing_2_DataBuffer[(GMAC_1_MAX_TXBUFF_SUPPORTED * GMAC_1_MAX_TXBUFFLEN_SUPPORTED)], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
#endif
...
#endif
#ifdef GMAC_1_RXRING_2_DESCR
    /*! @brief Reception buffer descriptors for Rx Ring 2 */
    VAR_ALIGN(Gmac_Ip_BufferDescriptorType GMAC_1_RxRing_2_DescBuffer[GMAC_1_MAX_RXBUFF_SUPPORTED], FEATURE_GMAC_BUFFDESCR_ALIGNMENT_BYTES)
#endif
