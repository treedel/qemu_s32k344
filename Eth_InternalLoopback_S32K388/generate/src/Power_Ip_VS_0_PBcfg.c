...
static const Power_Ip_MC_ME_CofbConfigType Power_Ip_MC_ME_aPartition2CofbConfigPB_0[3U] = 
{
    ...
    /* The configuration structure for Partition 2 COFB 1. */
    {
        ...
        (
            ((uint32)0x00000000U) | MC_ME_PRTN2_COFB1_CLKEN_REQ33_MASK | MC_ME_PRTN2_COFB1_CLKEN_REQ34_MASK | MC_ME_PRTN2_COFB1_CLKEN_REQ58_MASK
        ),
...
static const Power_Ip_PMC_ConfigType Power_Ip_PMC_ConfigPB =
{
    ...
    (
    ((uint32)0x00000000U) | PMC_CONFIG_LPM25EN_MASK
    )
