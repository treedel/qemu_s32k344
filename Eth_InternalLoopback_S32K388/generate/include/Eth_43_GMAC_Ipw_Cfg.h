...
#define ETH_43_GMAC_IPW_CFG_AR_RELEASE_MINOR_VERSION     9
#define ETH_43_GMAC_IPW_CFG_AR_RELEASE_REVISION_VERSION  0
#define ETH_43_GMAC_IPW_CFG_SW_MAJOR_VERSION             7
#define ETH_43_GMAC_IPW_CFG_SW_MINOR_VERSION             0
#define ETH_43_GMAC_IPW_CFG_SW_PATCH_VERSION             1
...
typedef struct
{
    uint8 BuffMapToQueue;
    uint8* BuffAddr;

} Eth_43_GMAC_Ipw_axRxBuffAddrMapType;
...
typedef struct sEth_43_GMAC_Ipw_CtrlConfigType
{
    ...
    const Gmac_Ip_TxRxClkMuxBypassType Eth_43_GMAC_Ipw_TxRxClkMuxBypassConfig;
#endif
	#if (STD_ON == ETH_43_GMAC_PPS_OUTPUT_SUPPORT)
    const uint8 PPSFrequency;
    #endif
    uint16 RxBuffCount;
    Eth_43_GMAC_Ipw_axRxBuffAddrMapType * Eth_43_GMAC_Ipw_apListOfRxBuffAddrConfig;
