...
#define TSPC_PORT_IP_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG_H        9
#define TSPC_PORT_IP_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG_H     0
#define TSPC_PORT_IP_SW_MAJOR_VERSION_VS_0_PBCFG_H                7
#define TSPC_PORT_IP_SW_MINOR_VERSION_VS_0_PBCFG_H                0
#define TSPC_PORT_IP_SW_PATCH_VERSION_VS_0_PBCFG_H                1
